...
# Added all necessary objects for a successful link
...
# The key fix: Add -Isrc so "zip/zfile.h" is resolved correctly
EE_INCS = -I. -Isrc -Isrc/cps2 -Isrc/zip -Isrc/sound -I$(PS2SDK)/ee/include -I$(PS2SDK)/common/include -I$(PS2SDK)/ports/include
